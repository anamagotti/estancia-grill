...
export const CHECKLIST_ATENDIMENTO: ChecklistSection[] = [
  {
    ...
    items: [
      ...
      { category: "Mesas Limpas", item: "Paliteiro, saleiro e papeleiro nas mesas", points: 5 },
...
export const CHECKLIST_LIMPEZA: ChecklistSection[] = [
  {
    ...
    items: [
      { category: "Obrigatórias", item: "Limpar os banheiros de funcionários e clientes", points: 5 },
      { category: "Obrigatórias", item: "Limpar hall de entrada interno e externo", points: 4 },
      { category: "Obrigatórias", item: "Limpar a entrada do estacionamento", points: 4 },
      { category: "Obrigatórias", item: "Limpeza do buffet", points: 5 },
      { category: "Obrigatórias", item: "Limpeza da área de sushi", points: 5 },
      { category: "Obrigatórias", item: "Limpeza dos escritórios", points: 4 },
      { category: "Obrigatórias", item: "Limpeza do refeitório", points: 4 },
      { category: "Obrigatórias", item: "Limpeza das portas de entrada", points: 4 },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { category: "Buffet", item: "Tirar o pó dos móveis e decorações", points: 3 },
      { category: "Buffet", item: "Limpeza dos vidros e espelhos da área do buffet", points: 3 },
    ],
  },
  {
